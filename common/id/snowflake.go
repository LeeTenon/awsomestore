...
var defaultNode = &Node{
    ...
    seqMask:           uint32(bitsToMax(defaultOption.SequenceBits)),
    workerIdShift:     uint32(defaultOption.SequenceBits),
    dataCenterIdShift: uint32(defaultOption.SequenceBits + defaultOption.WorkerIdBits),
    timestampShift:    uint32(defaultOption.SequenceBits + defaultOption.WorkerIdBits + defaultOption.DataCenterIdBits),
    lastTs:            -1,
    mu:                sync.Mutex{},
}
